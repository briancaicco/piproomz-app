...
mod.run(($templateCache) => {
    // customPosts
    $templateCache.put('customPosts/broker/item.html', require('!html!./customPosts/broker/item.html'));
    $templateCache.put('customPosts/broker/list.html', require('!html!./customPosts/broker/list.html'));

    $templateCache.put('customPosts/signal/item.html', require('!html!./customPosts/signal/item.html'));
    $templateCache.put('customPosts/signal/list.html', require('!html!./customPosts/signal/list.html'));

    $templateCache.put('customPosts/glossary/item.html', require('!html!./customPosts/glossary/item.html'));
    $templateCache.put('customPosts/glossary/list.html', require('!html!./customPosts/glossary/list.html'));
    ...
    // then paste it in the current folder `config/templates`
